# World Sauna Forum live JSON update guide

Live data file: content\categories\wellness\sauna\events\world-sauna-forum-live.json
...
Go directly to: https://www.worldsaunaforum.com/

Collect confirmed data for: Programme tracks, speakers, sauna visits and booking status.

## Visual guidance

Use programme cards, track badges and practical visitor tables.
