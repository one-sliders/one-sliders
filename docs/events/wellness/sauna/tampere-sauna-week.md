# Tampere Sauna Week live JSON update guide

Live data file: content\categories\wellness\sauna\events\tampere-sauna-week-live.json
...
Go directly to: https://visittampere.fi/en/

Collect confirmed data for: Daily sauna programme, venues, booking status and public transport notes.

## Visual guidance

Use day cards, venue tables and practical icons.
