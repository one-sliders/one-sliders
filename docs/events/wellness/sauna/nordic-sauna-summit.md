# Nordic Sauna Summit live JSON update guide

Live data file: content\categories\wellness\sauna\events\nordic-sauna-summit-live.json
...
Go directly to: https://www.saunafromfinland.com/

Collect confirmed data for: Talk programme, hosted sauna sessions, networking and travel leg between cities.

## Visual guidance

Use programme cards, speaker/session table and country links when verified.
