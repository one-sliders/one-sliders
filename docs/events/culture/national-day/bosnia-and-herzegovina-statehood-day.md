...
- English page: `en/content/categories/culture/national-day/events/bosnia-and-herzegovina-statehood-day.html`
...
- OneSliders country page: `/content/locations/europe/bosnia-and-herzegovina/`

## Update Notes

- Keep the event evergreen: the URL should not include a year.
- Update Slide 2 when official 2026 local programmes are published.
