# Apple WWDC live JSON update guide

Live data file: content\categories\technology\developer-conferences\events\apple-wwdc-live.json
...
Go directly to: https://developer.apple.com/wwdc/

Collect confirmed data for: Keynote announcements, platform sessions, betas and developer tools.

## Visual guidance

Use platform cards, announcement table and session track badges.
