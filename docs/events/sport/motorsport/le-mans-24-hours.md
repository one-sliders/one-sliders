# Le Mans 24 Hours live JSON update guide

Live data file: en\content\categories\sport\motorsport\events\le-mans-24-hours-live.json
...
Go directly to: https://www.24h-lemans.com/en

Collect confirmed data for: Starting grid, class leaders, hour-by-hour status and final classification.

## Visual guidance

Use class tables, progress meter and country flags for teams/drivers when verified.
